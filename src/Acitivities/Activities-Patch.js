...
const ActivitiesPatch = ({activityId, setActivityId, token}) => {
    ...
    return <>
        <div className='updateActivity'>
            <h1 style={{ fontSize: '32px', color: '#333', textAlign: 'center', marginTop: '40px'}}>Update An Activity</h1>
...
export default ActivitiesPatch;